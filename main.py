...
class PatientDetails(Screen):
    ...
    def generate_BP(self, *args):
        global timer 
        #added line to show finish button (replacing function of back button that was removed)
        ...
        def check_data():
            ...
            if serialPort.inWaiting() > 0:
                ...
                sql = "INSERT INTO vitals (id, sys_mmHg, dia_mmHg, BP_cart) VALUES (%s, %s, %s, %s) ",(comment_box["N_id2"], c_BP["sys_mmHg"], c_BP["dia_mmHg"], category["BP_cart"])
                print(sql)
                ...
                cur.execute("INSERT INTO vitals (id, sys_mmHg, dia_mmHg, BP_cart) VALUES (%s, %s, %s, %s) ",
                                            (comment_box["N_id2"], c_BP["sys_mmHg"], c_BP["dia_mmHg"], category["BP_cart"]))
